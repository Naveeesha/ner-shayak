...
async function getActiveDisruptions() {
  ...
  // SQLite fallback
  const reports = db.prepare(`SELECT * FROM field_reports WHERE status IN ('open','in_progress') AND category IN ('road_block','landslide','flood','bridge_damage','accident')`).all();
